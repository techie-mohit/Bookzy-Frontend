...
import { authStatus, setUser, toggleLoginDialog } from "@/store/slice/userSlice";
import { set } from "date-fns";
import { AnimatePresence, motion } from "framer-motion";
import { CheckCircle, ExternalLink, Eye, EyeOff, Loader2, Lock, Mail, User } from "lucide-react";
...
const AuthPage = () => {
  ...
  const onSubmitLogin = async(data: LoginFormData)=>{
    ...
    try {
      ...
      console.log(error);
      const message = error?.data?.message || "Login failed. Email or password is incorrect";
      toast.error(message);
    }
    finally{
              ...
              >
                <TabsContent value="login" className="space-y-4">
                  <form onSubmit={handleLoginSubmit(onSubmitLogin)} className="space-y-4">
                    ...
                    <Button
                      type="submit"
                     className=" w-full  flex justify-center items-center font-bold bg-gradient-to-r from-purple-600 to-indigo-700 text-white hover:from-purple-700 hover:to-indigo-800"
                    >
                      {loginLoading ? (
                        <>
                          <Loader2
                  ...
                  <div className="text-center mt-4">
                    ...
                    <Link href="/" className="text-sm text-purple-600 hover:underline">Return to main site</Link>
